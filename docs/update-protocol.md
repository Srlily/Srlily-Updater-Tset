...
JSON Schema：`src/Srlily.UpdaterTset/Data/schema/update-manifest.schema.json`
...
2. **校验** `checksums.sha256` 中对应 zip 的 SHA256
3. **解压** 到 staging 子目录
...
# 清单版本
(Get-Content .\update-manifest.json | ConvertFrom-Json).version
